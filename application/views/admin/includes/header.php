<?php
    if(!isset($_SESSION['admin_id'])){
        header('Location:'.base_url('welcome/admin_login'));
    }
?>
                ...
                <div class="container">
                    <div class="logo">
                        <a href="#" class="logo">
                            ...
                            <h2 class="uvk-head">Event Management APP</h2>
                        </a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            ...
                            <li class="dropdown navbar-c-items">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    ...
                                    <li><a href="<?php echo base_url('welcome/admin_logout');?>"><i class="ti-power-off m-r-5"></i> Logout</a></li>
                                </ul>
                ...
                <div class="container">
                    <div id="navigation">
                            <li class="has-submenu">
                                <a href="<?php echo base_url('welcome/vendors_list');?>"><i class="mdi mdi-view-dashboard"></i>Vendors</a>
                            </li>
                            <li class="has-submenu">
                                <a href="<?php echo base_url('welcome/products_list');?>"><i class="mdi mdi-view-dashboard"></i>Events</a>
                            </li>
                            <li class="has-submenu">
                                <a href="<?php echo base_url('welcome/booking_list');?>"><i class="mdi mdi-view-dashboard"></i>Bookings</a>
                            </li>
                        </ul>
                    </div>
                </div>
